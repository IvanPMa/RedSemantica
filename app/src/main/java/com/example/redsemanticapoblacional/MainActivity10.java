        ...
        siguiente.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if  (b1.isEmpty() || b2.isEmpty() || b3.isEmpty() || b4.isEmpty()){
                    ...
                    creacionbase.agregarPalabras ("Satisfaccion",b1,b2,b3,b4,b5,tiempo);
                    //Verificar si los datos fueron agregados correctamente
                    Toast.makeText(getApplicationContext(),"Datos guardados 9/15",Toast.LENGTH_SHORT).show();
                    Intent siguiente = new Intent(MainActivity10.this, MainActivity11.class);
